...
def test(model, test_loader, criterion, device, epoch_no):
    '''
    function that can take a model and a testing data loader and will get the test accuray/loss of the model
    '''
...
def train(model, train_loader, criterion, optimizer, device, epoch_no):
    '''
     function that can take a model and data loaders for training and will get train the model
    '''
...
def net():
    ...
    # Adding 2 fully connected layers to adjust for number of classes (3)
...
def create_data_loaders(data, batch_size):
    '''
    function to implement data loaders 
    '''
