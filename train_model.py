...
def test(model, test_loader, criterion, device, epoch_no, hook):
    '''
    function that take a model and a testing data loader and will get the test accuray/loss of the model
    '''
...
def train(model, train_loader, criterion, optimizer, device, epoch_no, hook):
    '''
    function that take a model and data loaders for training and will get train the model
    '''
